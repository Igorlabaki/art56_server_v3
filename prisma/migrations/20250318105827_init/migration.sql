...
CREATE TABLE `Permission` (
    `id` VARCHAR(191) NOT NULL,
    `name` ENUM('VIEW_INFO', 'VIEW_EVENTS', 'VIEW_IMAGES', 'VIEW_CALENDAR', 'VIEW_ANALYSIS', 'VIEW_PROPOSALS', 'VIEW_NOTIFICATIONS', 'EDIT_INFO', 'EDIT_IMAGE', 'EDIT_VENUE', 'EDIT_EVENT', 'EDIT_PROPOSAL', 'EDIT_CALENDAR', 'EDIT_ORGANIZATION') NOT NULL,
...
-- CreateTable
CREATE TABLE `_PermissionToUserPermission` (
    `A` VARCHAR(191) NOT NULL,
    `B` VARCHAR(191) NOT NULL,

    UNIQUE INDEX `_PermissionToUserPermission_AB_unique`(`A`, `B`),
    INDEX `_PermissionToUserPermission_B_index`(`B`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
