...
import { CreateOvernigthDateEventRequestParmsSchema } from "../../../zod/dataEvent/create-overnithg-date-event-request-params-schema";

class CreateOvernightDateEventUseCase {
    constructor(
    ...
    async execute(params: CreateOvernigthDateEventRequestParmsSchema) {
        const { proposalId, userId, username, venueId, data } = params
        const { endDay,startDay, endHour, startHour, ...rest } = data
...
export { CreateOvernightDateEventUseCase }