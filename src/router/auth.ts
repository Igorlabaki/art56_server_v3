...
import { resetPasswordFactory } from "../use-cases/auth/reset-password/factory-reset-password";
import { forgotPasswordFactory } from "../use-cases/auth/forgot-password/factory-forgot-password";
...
authRoutes.put("/reset-password", async (req, res) => {
    const controller = resetPasswordFactory();  // Cria o controlador
    await controller.handle(req, res);         // Chama o método handle de forma assíncrona
})
